...
$(function () {
	...
	$(document).ready(function () {
		...
		var chart = new ApexCharts(
			document.querySelector("#apex-MainCategories"),
			options,
		);
		chart.render();
	});
	...
	$(document).ready(function () {
		var options = {
			...
			labels: ["PIC Free", "Working on Tickets"],
			dataLabels: {
				enabled: false,
			},
			legend: {
		...
		var chart = new ApexCharts(
			document.querySelector("#apex-PICData"),
			options,
		);
		chart.render();
	});
	...
	$(document).ready(function () {
		var options = {
			series: [
				{
					name: "Tickets",
					data: [4, 19, 7, 35, 14, 27, 9, 12, 5, 10, 8, 15],
				},
			],
		...
		var chart = new ApexCharts(
			document.querySelector("#apex-ticketStatistics"),
			options,
		);
	...
	$(document).ready(function () {
		...
		var chart = new ApexCharts(
			document.querySelector("#hiringsources"),
			options,
		);
		chart.render();
	});
