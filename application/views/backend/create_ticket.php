  ...
  <div class="container-xxl">
    ...
    <div class="row mb-4">
      <div class="col-12">
        ...
        <p class="text-muted mb-0">Solusi tidak ditemukan. Silakan lengkapi formulir di bawah ini agar tim dukungan kami dapat membantu Anda.</p>
      </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="card ct-form-card">
          <div class="card-body p-4">
            ...
            <form id="ct-ticket-form" enctype="multipart/form-data">
              <!-- Judul Pertanyaan -->
              <div class="mb-4">
                <label for="ct-judul" class="form-label fw-bold ct-label">JUDUL PERTANYAAN <span class="text-danger">*</span></label>
              ...
              <!-- Kategori -->
              <div class="mb-4">
                <label for="ct-kategori" class="form-label fw-bold ct-label">KATEGORI <span class="text-danger">*</span></label>
              ...
              <!-- Deskripsi Masalah -->
              <div class="mb-3">
                <label for="ct-deskripsi" class="form-label fw-bold ct-label">DESKRIPSI MASALAH <span class="text-danger">*</span></label>
              ...
              <p class="text-muted small mb-4">Sertakan detail yang relevan seperti waktu kejadian dan pesan error yang muncul.</p>

              <!-- Lampiran -->
              <div class="mb-3">
                <label class="form-label fw-bold ct-label">LAMPIRAN (OPSIONAL)</label>
                <div class="ct-upload-area" id="ct-upload-area">
                  <input type="file" class="d-none" id="ct-file-input" name="lampiran" accept=".png,.jpg,.jpeg,.pdf" multiple>
                  <div class="ct-upload-content text-center" id="ct-upload-content">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="mb-2 text-muted" viewBox="0 0 16 16">
      ...
      <div class="col-lg-4">
            ...
            <div class="ct-service-option active mb-3" id="ct-opt-regular" data-type="regular">
              <div class="d-flex align-items-start">
                ...
                <div>
                  ...
                  <p class="text-muted small mb-0">Layanan standar untuk masalah umum. Waktu respon estimasi 1×24 jam kerja.</p>
                </div>
              </div>
            </div>
            ...
            <div class="ct-service-option" id="ct-opt-token" data-type="token">
              <div class="d-flex align-items-start">
                ...
                <div>
                  ...
                  <p class="text-muted small mb-0">Prioritas tinggi. Membutuhkan kode token khusus untuk memilih tim IKS sesuai yang anda mau.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="card ct-form-card mb-4 d-none" id="ct-token-card">
          <div class="card-body p-4">
            <label for="ct-token-input" class="form-label fw-bold ct-label">KODE TOKEN <span class="text-danger">*</span></label>
        ...
        <div class="card ct-submit-card">
          <div class="card-body p-4 text-center">
            ...
            <p class="text-muted small mb-3">Dengan mengirimkan tiket, Anda menyetujui kebijakan prosedur dukungan Team IT IKS.</p>
...
<style>
  ...
  .col-lg-4 .ct-form-card:nth-child(1) { animation-delay: 0.1s; }
  .col-lg-4 .ct-submit-card { animation: fadeInUp 0.4s ease 0.15s forwards; }
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showSuccessModal() {
    ...
    overlay.innerHTML = '<div class="ct-success-modal text-center">' +
      ...
      '<p class="mb-4"><span class="badge bg-light text-dark px-3 py-2 fs-6">No. Tiket: TKT-' + generateTicketNo() + '</span></p>' +
      '<button class="btn ct-submit-btn px-4 py-2" onclick="window.location.href=\'' + '<?= base_url("dash"); ?>' + '\'">Kembali ke Dashboard</button>' +
      '</div>';
