          ...
          <div class="card-body p-4">
            ...
            <div class="mb-3">
              <label for="ct-deskripsi" class="form-label fw-bold ct-label">DESKRIPSI MASALAH <span
                  class="text-danger">*</span></label>
              <textarea class="form-control ct-input ct-textarea" id="ct-deskripsi" name="deskripsi" rows="5" required
                placeholder="Jelaskan langkah-langkah terjadinya error secara detail..."></textarea>
            </div>
      ...
      <div class="col-lg-4">
        ...
        <div class="card ct-form-card mb-4">
          <div class="card-body p-4">
            ...
            <input type="hidden" name="assignment_type" , id="assignment_type" value="Regular">

            <!-- Regular Option -->
            <div class="ct-service-option active mb-3" id="ct-opt-regular" name="assignment_type" data-type="Regular">
            ...
            <!-- Token Urgent Option -->
            <div class="ct-service-option" id="ct-opt-token" name="assignment_type" data-type="Token">
              <div class="d-flex align-items-start">
                <div class="ct-service-icon me-3">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    viewBox="0 0 16 16">
