        ...
        <div class="sidebar px-4 py-4 py-md-5 me-0">
            <div class="d-flex flex-column h-100">
                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li><a class="m-link" href="<?= base_url('knowledge-base'); ?>"><i class="icofont-light-bulb fs-5"></i>
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse" id="tikit-Components">
                            <li><a class="ms-link" href="tickets.html"> <span>All Tickets</span></a></li>
                            <li><a class="ms-link" href="tickets.html"> <span>Waiting <span
                                            class="badge bg-info rounded-pill">1</span></span></a></li>
                            <li><a class="ms-link" href="ticket-detail.html"> <span>On Progress <span
                                            class="badge bg-success rounded-pill">2</span></span></a></li>
                            <li><a class="ms-link" href="ticket-detail.html"> <span>Pending <span
                                            class="badge bg-warning rounded-pill">3</span></span></a></li>
                            <li><a class="ms-link" href="ticket-detail.html"> <span>Resolved <span
                                            class="badge bg-secondary rounded-pill">2</span></span></a></li>
                            <li><a class="ms-link" href="ticket-detail.html"> <span>Closed <span
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse" id="issues">
                            <li><a class="ms-link" href="tickets.html"> <span>All Issues</span></a></li>
                            <li><a class="ms-link" href="ticket-detail.html"> <span>Open Issues</span></a></li>
                            <li><a class="ms-link" href="ticket-detail.html"> <span>Reported by Me</span></a></li>
                        </ul>
                    </li>
                    <!-- END -->
                </ul>
